  ...
  return (
    <main className="min-h-screen bg-[#F8FAFD] px-5 py-16 sm:px-8">
      <div className="mx-auto max-w-3xl text-center">
        <p className="mkt-type-eyebrow font-mono tracking-[0.14em] text-[#087D70] uppercase">Private scan · available for 30 days</p>
        <h1 className="mkt-type-section-title mt-3 font-semibold tracking-[-0.045em] text-[#0B1736]">Website structure comparison</h1>
