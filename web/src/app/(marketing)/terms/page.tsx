...
export default function TermsPage() {
  return (
    <section className="mx-auto max-w-3xl px-6 py-16">
      <h1 className="mkt-type-page-title font-semibold tracking-tight text-[#141A3A]">Service Terms</h1>
      ...
      <div className="mkt-type-body mt-10 space-y-8 text-[#545C70]">
        ...
        <section>
          <h2 className="mkt-type-card-title font-semibold text-[#141A3A]">Static export boundary</h2>
        ...
        <section>
          <h2 className="mkt-type-card-title font-semibold text-[#141A3A]">Payments and cancellation</h2>
