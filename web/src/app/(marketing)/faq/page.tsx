...
const FAQ: FaqItem[] = [
  ...
  },
  {
    id: 'seo',
    q: 'SEO가 뭔가요?',
    a: '손님이 네이버나 구글에서 지역과 서비스를 검색할 때 가게 홈페이지를 찾을 수 있도록 준비하는 일입니다. 페이지마다 가게 이름·지역·서비스를 분명히 쓰고, 검색 서비스가 읽을 제목과 설명을 맞춥니다.',
    plain: '손님이 네이버나 구글에서 지역과 서비스를 검색할 때 가게 홈페이지를 찾을 수 있도록 페이지 제목과 설명, 가게 정보를 분명히 정리하는 일입니다.',
  },
  {
    id: 'aeo',
    q: 'AEO가 뭔가요?',
    a: '“주차 되나요?”, “예약은 어떻게 하나요?”처럼 손님이 자주 묻는 질문에 검색 화면이 홈페이지의 답을 바로 보여주기 쉽게 만드는 일입니다. 실제 영업 정보가 있는 질문과 답을 또렷하게 짝지어 둡니다.',
    plain: '주차, 예약처럼 손님이 자주 묻는 질문에 검색 화면이 홈페이지의 답을 보여주기 쉽도록 실제 질문과 답을 분명히 정리하는 일입니다.',
  },
  {
    id: 'geo',
    q: 'GEO가 뭔가요?',
    a: '손님이 AI에게 가게를 물었을 때 AI가 확인할 공식 근거를 홈페이지에 갖추는 일입니다. 상호·주소·전화번호·서비스와 공식 채널 정보를 한뜻으로 맞추고, 출처로 인용하기 쉬운 문장으로 정리합니다.',
    plain: '손님이 AI에게 가게를 물었을 때 확인할 공식 근거가 있도록 상호, 주소, 전화번호, 서비스와 공식 채널 정보를 한뜻으로 정리하는 일입니다.',
  },
  {
