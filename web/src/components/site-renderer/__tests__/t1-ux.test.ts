...
describe('T1-4 앵커·CTA 전수 배선', () => {
  ...
  test('purchase 목표 → 히어로 CTA가 상품 진열(#sec-gallery)로', () => {
    const cfg = buildSiteConfigFromSurvey(surveyFor('ecommerce', '패션', { siteGoal: 'purchase' }), candidate, opts);
