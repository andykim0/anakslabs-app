...
export const surveyFormSchema = z.object({
  ...
  mode: z.enum(['fresh', 'improve']),
  sourceUrl: z.string(),
  sourceScanId: z.string(),
...
export function toFormDefaults(initial: SurveyInput | null, defaultBusinessName?: string): SurveyForm {
  ...
  return {
    ...
    brandStory: initial.contentDepth?.mainStorytelling?.brandStory ?? '',
    brandOrigin: initial.contentDepth?.mainStorytelling?.origin ?? '',
    brandPhilosophy: initial.contentDepth?.mainStorytelling?.philosophy ?? '',
    targetCustomer: initial.contentDepth?.surveyBrief?.targetCustomer ?? '',
    visitorNeed: initial.contentDepth?.surveyBrief?.visitorNeed ?? '',
    valueProposition: initial.contentDepth?.surveyBrief?.valueProposition ?? '',
    conversionKind: initial.contentDepth?.surveyBrief?.conversionDestination?.kind,
