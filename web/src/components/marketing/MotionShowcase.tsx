  ...
  return (
    <div className="grid items-center gap-10 md:grid-cols-2">
      <FadeIn>
        ...
        <h2 className="mkt-type-section-title mt-4 font-semibold tracking-tight text-[#17181C]">
          움직임도 브랜드의 언어가 됩니다
        </h2>
        ...
        <Link
          href="/pricing"
          className="mkt-type-control group mt-5 inline-flex items-center gap-1.5 font-medium text-[#174DDA] transition-colors hover:text-[#0B1736]"
        >
          AI 영상 홈페이지 자세히 보기
      ...
      <FadeIn delay={0.08}>
        <div className="relative">
          ...
          <span className="mkt-type-eyebrow absolute -top-2 right-4 z-10 rounded-full bg-gradient-to-r from-[#174DDA] to-[#03BFA9] px-2.5 py-1 font-mono font-semibold text-white ring-1 ring-white/70">
            AI 영상 홈페이지
          </span>
        </div>
      </FadeIn>
