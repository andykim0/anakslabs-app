...
const INDUSTRY_CLASS_SEEDS: IndustryClassSeed[] = [
  {
    ...
    purpose: 'Restaurants and local shops',
    industry: 'Fine dining or omakase',
    tone: ['elegant'],
    mood: 'elegant',
    strict: true,
  },
  ...
  },
  {
    ...
    purpose: 'Company or brand',
    industry: 'Startup, IT, or SaaS',
    tone: ['modern'],
    mood: 'modern',
    strict: false,
  },
  {
    ...
    purposeId: 'portfolio',
    purpose: 'Portfolio',
    industry: 'Graphic or product designer',
    tone: ['bold'],
    mood: 'energetic',
    strict: false,
  },
