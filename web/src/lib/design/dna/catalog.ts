...
export const DESIGN_DNA_CATALOG = [
  // 따뜻한 에디토리얼 무드 — 카페·베이커리의 메뉴와 공간 이야기에 친화적.
  {
    ...
    description: 'Warm editorial contrast for menus and stories about the space.',
  ...
  // 절제된 다이닝 무드 — 식당·파인다이닝의 메뉴 위계와 긴 호흡에 친화적.
  {
    ...
    description: 'Restrained dining contrast with clear menu hierarchy and generous pacing.',
  ...
  // 부드럽고 여유로운 웰니스 무드 — 미용·살롱의 서비스 안내에 친화적.
  {
    ...
    description: 'Soft wellness pacing for services and booking information.',
  ...
  // 명료하고 안정적인 임상 무드 — 의료 정보의 빠른 판독과 신뢰에 친화적.
  {
    ...
    description: 'Clear clinical information in a trustworthy, scannable structure.',
  ...
  // 권위 있고 차분한 문서 무드 — 법률·자문의 절차와 근거 설명에 친화적.
  {
    ...
    description: 'An authoritative editorial hierarchy for procedures and supporting evidence.',
    moodFamily: 'refined-editorial',
  ...
  // 손맛과 재료감이 느껴지는 헤리티지 무드 — 공방·수공예 과정 소개에 친화적.
  {
    ...
    description: 'A tactile heritage treatment for craft, process, and finished work.',
    moodFamily: 'warm-tactile',
  ...
  // 구조적이고 친근한 학습 무드 — 학원·교육 정보의 단계별 이해에 친화적.
  {
    ...
    description: 'A structured, approachable learning format for steps and choices.',
    moodFamily: 'structured-clarity',
  ...
  // 선명하고 기하학적인 상품 무드 — 리테일의 카테고리·제품 탐색에 친화적.
  {
    ...
    description: 'Crisp geometry for fast product and category exploration.',
