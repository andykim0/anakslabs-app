...
export const CREDIT_CONTRACT_COPY =
  ...
  + `크레딧은 다보임 AI에게 다시 만들어 달라고 맡길 때 사용합니다: 문구 재생성 ${CREDIT_COSTS.text}크레딧, 이미지 재생성 ${CREDIT_COSTS.image}크레딧, 구성 변경 ${CREDIT_COSTS.structure}크레딧, 영상 재생성 ${CREDIT_COSTS.video}크레딧입니다. `
