...
test('온보딩은 답한 사실만 저장하고 신규 제출에 contentDepth 게이트를 고정한다', () => {
  ...
  assert.match(step, /Do not make up information that is not answered/);
  assert.match(step, /The more you answer, the more fact-based guidance and sections we can include/);
